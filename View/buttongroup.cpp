...
void ButtonGroup::initButtons()
{
    ...
    connect(ui->oneScore,&QPushButton::clicked,this,[=](){
        emit betPoint(1);
    });
    connect(ui->twoScore,&QPushButton::clicked,this,[=](){
        emit betPoint(2);
    });
    connect(ui->threeScore,&QPushButton::clicked,this,[=](){
        emit betPoint(3);
    });
}
